...
- `kafka-monitoring.py`: Completing python script to send relevant metrics.

- `docker-compose.yaml`: Adding kafka services such as zookeeper, kafka, and kafka exporter (kafka exporter is useful to get metrics about kafka performace).

- `prometheus/prometheus.yml`: Adding targets with correct confs like the ip. This file is custom because we are used all in dockers like Kafka, Prometheus, Grafana, etc. Only the requests metrics are running in local host port 8765.

## New files:

-  `KafkaDemo.ipynb`: Notebook used to send syntetic data to the kafka topic to be ingested by the kafka monitoring and displayed in dashboards.



## Results

- Docker compose sucessfully execution:

<img src="images_rd/1.png" alt="Imagen 1" width="300">

- Prometheus wirh all endpoints UP ready to get metrics:

<img src="images_rd/2.png" alt="Imagen 2" width="300">

- 1st panel in Grafana:

<img src="images_rd/3.png" alt="Imagen 2" width="300">

- Custom queries to add advanced dashboards in Grafana:

<img src="images_rd/4.png" alt="Imagen 2" width="300">

- Panel 2 and 3 in Grafana:

<img src="images_rd/5.png" alt="Imagen 2" width="300">

- Panel 3 and 4 in Grafana:
